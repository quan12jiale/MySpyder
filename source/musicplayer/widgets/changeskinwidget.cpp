...
{
    use_skin_button->setText("use skin");
}

void ChangeSkinWidget::changeSkin(QString pixmap_name, QString skin_name)
{
    this->pixmap_name = pixmap_name;

    //更改皮肤背景
    QPixmap pixmap(this->pixmap_name);
